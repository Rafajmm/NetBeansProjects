...
public class Memorion {
    ...
    public static void maquinaFacil(char matriz[][], int ajustes[]){
        ...
        while((jugador[0]<pareja && jugador[1]>0) || (maquina[0]<pareja && maquina[1]>0)){
            ...
            if(turnoJugador){
                ...
                if(ajustes[3]==pareja-1){
                    ...
                    System.out.println("Te quedan "+maquina[1]+" intentos");
                }
            }
    ...
    public static void main(String[] args) {
        ...
        while(!salir){
            ...
            switch(opcion){
                ...
                case'm': 
                char simbolos2[]=simbolos(ajustes);                    
                matriz=rellenarMatriz(generarMatriz(ajustes),simbolos2);
